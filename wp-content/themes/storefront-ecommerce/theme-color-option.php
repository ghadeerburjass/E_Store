<?php
	...
	if($storefront_ecommerce_preloader_bg_image != false){
		$storefront_ecommerce_custom_css .='.frame{';
			$storefront_ecommerce_custom_css .='background: url('.esc_attr($storefront_ecommerce_preloader_bg_image).');';
		$storefront_ecommerce_custom_css .='}';
	}
	...
	$storefront_ecommerce_custom_css .='.primary-navigation a, .primary-navigation ul li a, #site-navigation li a{';
			$storefront_ecommerce_custom_css .='color: '.esc_attr($storefront_ecommerce_menu_color).' !important;';
	$storefront_ecommerce_custom_css .='}';

	// Sub menu color
	$storefront_ecommerce_sub_menu_color = get_theme_mod('storefront_ecommerce_sub_menu_color');
	$storefront_ecommerce_custom_css .='.primary-navigation ul.sub-menu a, .primary-navigation ul.sub-menu li a, #site-navigation ul.sub-menu li a{';
	...
	$storefront_ecommerce_custom_css .='.primary-navigation a:hover, .primary-navigation ul li a:hover, #site-navigation ul.sub-menu li a:hover, #site-navigation li a:hover{';
			$storefront_ecommerce_custom_css .='color: '.esc_attr($storefront_ecommerce_menu_hover_color).' !important;';
	$storefront_ecommerce_custom_css .='}';

	// Sub menu hover color
	$storefront_ecommerce_sub_menu_hover_color = get_theme_mod('storefront_ecommerce_sub_menu_hover_color');
	$storefront_ecommerce_custom_css .='.primary-navigation a:hover, .primary-navigation ul.sub-menu li a:hover, #site-navigation ul.sub-menu li a:hover{';
	...
	$storefront_ecommerce_custom_css .='#site-navigation ul.sub-menu li a{';
	...
	$storefront_ecommerce_custom_css .='#site-navigation ul.sub-menu li a:hover{';
