                ...
                <div class="<?php if( get_theme_mod( 'storefront_ecommerce_sticky_header', false) != '') { ?> sticky-header<?php } else { ?>close-sticky <?php } ?>">
                  ...
                  if(has_nav_menu('primary')){ ?>
                    <div class="toggle-menu responsive-menu">
                      <button role="tab" onclick="storefront_ecommerce_menu_open()" class="mobiletoggle"><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_responsive_menu_open_icon','fas fa-bars')); ?>"></i><?php echo esc_html( get_theme_mod('storefront_ecommerce_open_menu_label', __('Open Menu','storefront-ecommerce'))); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','storefront-ecommerce'); ?></span>
                      </button>
                    </div>
                  <?php }?>
                  <div id="navbar-header" class="menu-brand primary-nav">
                    ...
                    <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="storefront_ecommerce_menu_close()"><?php echo esc_html( get_theme_mod('storefront_ecommerce_close_menu_label', __('Close Menu','storefront-ecommerce'))); ?><i class="<?php echo esc_attr(get_theme_mod('storefront_ecommerce_responsive_menu_close_icon','fas fa-times')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','storefront-ecommerce'); ?></span></a>
                  </div>
                </div>
              </div>
            </div>
